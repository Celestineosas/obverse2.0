...
export const TransactionDetails : TransactionDetailsProps[] = [
  { label: "Faiza", asseticon: assetIcon, amount: 251, net:250, asset: "USDC", date: "18 Sep 2025" },
  { label: "Sam", asseticon: assetIcon, amount: 57.50, net:56, asset: "USDT" , date: "18 Sep 2025" },
  { label: "Tolu", asseticon: assetIcon, amount: 41.50, net:40, asset: "USDT" , date: "18 Sep 2025" },
];
