...
import { logo, logoText } from "@/assets/icons"; // adjust import paths
...
const Navbar = () => {
  ...
  return (
    <header className="sm:pt-0 pt-0 w-full">
      <nav className="sm:px-10 lg:mx-20 sm:mx-15 mx-5 my-5 px-5 flex justify-between py-3 items-center rounded-[64px] bg-[#FFF9F7] border border-[#FFE9E3]">
        {/* Logo */}
